...
- NDS-003 method chain trivia — watching for recurrence ([issue #886](https://github.com/wiggitywhitney/spinybacked-orbweaver/issues/886)) — run-19 partial commit (claude-collector.js); runs 20, 21, and 23 all clean with no recurrence; no specific upstream fix identified; ready to close as resolved-by-side-effect.

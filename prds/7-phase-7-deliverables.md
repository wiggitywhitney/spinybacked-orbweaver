...
- [ ] **Milestone 10: Acceptance gate passes** — Full end-to-end run from CLI produces a reviewable PR on a feature branch with per-file commits. PR description includes all specified sections. User can estimate cost, monitor progress, and understand failures. Verify against a real test JavaScript project with Weaver schema.

// ABOUTME: Zod schema for orb.yaml agent configuration.
...
/**
 * Dependency installation strategy — set during `orb init` based on project type.
...
/**
 * Zod schema for orb.yaml — the single source of truth for config shape.

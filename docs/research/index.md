...
| traces-metrics-correlation.md | OTel Span Metrics Connector vs Datadog Generate Metrics from Spans: RED metric derivation, dimension cardinality constraints, coexistence in same Collector pipeline, pure OTel vs Datadog-native UI fidelity, Weaver schema angle | 2026-06-16 |

...
The eval data confirms: every file that committed with new schema extensions used ≤2 attempts. Every 3-attempt file registered zero new attributes.

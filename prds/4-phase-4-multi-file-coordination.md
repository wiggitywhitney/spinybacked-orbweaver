...
| Periodic Schema Checkpoints | Reference only | 512–516 | All periodic checkpoint logic deferred to Phase 5. Phase 4 defines the `onSchemaCheckpoint` callback in `CoordinatorCallbacks` (hook point) but does not wire it. Read for context on what Phase 5 will add. |
